        ...
        public bool Read ()
        {
            ...
            while (true) {
                ...
                try {
                    ...
                    string curText;
                    if(current_input > Char.MaxValue)
                    {
                        curText = ((ParserToken)current_input).ToString();
                    }
                    else
                    {
                        curText = ((char)current_input).ToString();
                    }
                    UnityEngine.Debug.Log(string.Format("ParserToken failed in '{0}'",curText));
